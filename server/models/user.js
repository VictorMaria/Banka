const userQueries = {
  ...
  staffStatusQuery: 'UPDATE users SET type = $1, is_staff = $2 WHERE id = $3 returning type, is_staff',
  adminStatusQuery: 'UPDATE users SET type = $1, is_admin = $2 WHERE id = $3 returning type, is_admin',
